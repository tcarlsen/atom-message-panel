...
MessagePanelView.prototype.resizePanel = function (e) {
  var
    ...
    workspaceHeight = $(document.body).height(),
    distanceFromBottomToPanel = workspaceHeight -
      (panelBody.offset().top + panelBody.height()),
    newHeight = workspaceHeight - e.pageY - panelHeadingHeight
      - distanceFromBottomToPanel;
