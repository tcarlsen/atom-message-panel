...
var MessagePanelView = function (params) {
  ...
  this.pane = params.pane || false;
  this.closeMethod = params.closeMethod || 'detach';
  this.messages = [];
...
MessagePanelView.prototype.attach = function () {
  if (this.pane) {
    ...
    // TODO: Use HTMLElement For The View
    // atom.views.getView(atom.workspace.getActivePane()).append(this);
  } else {
